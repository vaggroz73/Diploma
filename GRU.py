...
def aggregate_season_level(df):
    print("\n" + "="*60)
    print("SEASON-LEVEL AGGREGATION")
    print("="*60)
...
def build_preprocessor(df_train, config):
    ...
    print("\n" + "="*60)
    print("PREPROCESSOR (fit on TRAIN only)")
    print("="*60)
...
print("\n" + "="*60)
print("PHASE A: HYPERPARAMETER TUNING")
...
print("\n" + "="*60)
print("FINAL MODEL REFIT (Train+Val)")
print("="*60)
